...
if (NOT DEFINED BUILD_CEREAL)
  find_library(CEREAL_LIBRARY NAMES cereal)
  find_path(cereal_INCLUDE_DIR cereal/archives/json.hpp)
  if (NOT cereal_LIBRARY OR NOT cereal_INCLUDE_DIR)
    set(BUILD_CEREAL ON)
    set(cereal_LIBRARY cereal)
    include_directories(SYSTEM ${LocalPrefix}/include/cereal)
  endif ()
...
elseif (BUILD_CEREAL)
  ...
  find_path(cereal_INCLUDE_DIR cereal/archives/json.hpp)
endif (NOT DEFINED BUILD_CEREAL)
