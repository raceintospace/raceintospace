...
void EditAst(void)
{
    ...
    IOBox(5, 47, 21, 115);
    IOBox(185, 47, 315, 115);
    RectFill(186, 48, 314, 114, 0);
    IOBox(165, 47, 181, 115);
    RectFill(6, 48, 20, 81, 0);
    RectFill(166, 48, 180, 81, 0);
    ShBox(7, 49, 19, 80);
    ShBox(7, 82, 19, 113);
    UPArrow(10, 52);
    DNArrow(10, 85);
    ShBox(167, 49, 179, 80);
    ShBox(167, 82, 179, 113);
    UPArrow(170, 52);
    DNArrow(170, 85);
    grSetColor(6);
    PrintAt(66, 37, "ASTRONAUTS");
    grSetColor(9);
    PrintAt(227, 37, "COSMONAUTS");
    ShBox(0, 120, 319, 199);
    OutBox(60, 125, 197, 195);
    RectFill(61, 126, 196, 194, 9);
    InBox(65, 129, 192, 191);
    RectFill(66, 130, 191, 190, 3);
    OutBox(6, 124, 43, 136);
    OutBox(6, 139, 43, 151);
    OutBox(6, 154, 43, 166);
    OutBox(6, 169, 43, 181);
    ...
    grSetColor(1);
    PrintAt(71, 138, "NAME:");
    PrintAt(71, 147, "SKILL:");
    PrintAt(94, 155, "CAP");
    PrintAt(94, 163, "L.M.");
    PrintAt(94, 171, "EVA");
    PrintAt(94, 179, "DOCK");
    PrintAt(94, 187, "ENDR.");
    ShBox(206, 126, 311, 146);
    RectFill(207, 127, 310, 145, 6);
    InBox(209, 129, 308, 143);
    ...
    for (i = 0; i < 106; i++) {
        M_Us[i] = Men[i].Cap + Men[i].LM + Men[i].EVA + Men[i].Docking + Men[i].Endurance;
    }

    for (i = 0; i < 106; i++) {
        M_Sv[i] = Sov[i].Cap + Sov[i].LM + Sov[i].EVA + Sov[i].Docking + Sov[i].Endurance;
    }
    ...
    while (1) {
        ...
        if ((x >= 6 && y >= 124 && x <= 43 && y <= 136 && mousebuttons > 0) || key == 'C') {
            ...
            if (Cnt == 0) {
                ChangeStat(now, Cur, Cnt);
            } else {
                ChangeStat(now2, Cur, Cnt);
            }
...
{
    RectFill(100, 133, 186, 141, 3);
    RectFill(122, 151, 186, 190, 3);
    grSetColor(6);
