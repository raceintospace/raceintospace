...
int CheckMax(char plr, int m)
{
    switch (m) {
    case 1:
        if (Data->P[plr].Probe[0].Num < 1 || Data->P[plr].Probe[0].Safety < 90) {
            return(1);
        } else {
            return(0);
        }
    ...
    case 2:
        if (Data->P[plr].Probe[1].Num < 1 || Data->P[plr].Probe[1].Safety < 90) {
            return(1);
        } else {
            return(0);
        }
    ...
    case 3:
        if (Data->P[plr].Probe[2].Num < 1 || Data->P[plr].Probe[2].Safety < 90) {
            return(1);
        } else {
            return(0);
        }
    ...
    case 4:
        if (Data->P[plr].Manned[0].Num < 1 || Data->P[plr].Manned[0].Safety < 90) {
            return(1);
        } else {
            return(0);
        }
    ...
    case 5:
        if (Data->P[plr].Manned[1].Num < 1 || Data->P[plr].Manned[1].Safety < 90) {
            return(1);
        } else {
            return(0);
        }
...
char SF(char plr, char m)
{
    ...
    switch (m) {
    case 1:
        num = Data->P[plr].Probe[0].Safety;
        break;

    case 2:
        num = Data->P[plr].Probe[1].Safety;
        break;

    case 3:
        num = Data->P[plr].Probe[2].Safety;
        break;

    case 4:
        num = Data->P[plr].Manned[0].Safety;
        break;

    case 5:
        num = Data->P[plr].Manned[1].Safety;
        break;
...
char SN(char plr, char m)
{
    ...
    switch (m) {
    case 1:
        num = Data->P[plr].Probe[0].Num;
        break;

    case 2:
        num = Data->P[plr].Probe[1].Num;
        break;

    case 3:
        num = Data->P[plr].Probe[2].Num;
        break;

    case 4:
        num = Data->P[plr].Manned[0].Num;
        break;

    case 5:
        num = Data->P[plr].Manned[1].Num;
        break;
