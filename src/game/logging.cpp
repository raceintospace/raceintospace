...
LOG_NEW_CATEGORY(mission)
  LOG_NEW_SUBCATEGORY(future, mission)
  LOG_NEW_SUBCATEGORY(prestige, mission)
LOG_NEW_CATEGORY(utils)
LOG_NEW_CATEGORY(filesys)
LOG_NEW_CATEGORY(config)
