...
void PrintHist(std::string_view buf);
void PrintOne(std::string_view buf, char tken);
    ...
    while (1) {
        ...
        if (key > 0 || mousebuttons > 0) {
            ...
            if ((x >= 14 && y >= 182 && x <= 65 && y <= 190 && mousebuttons > 0) || key == 'H') {
                R_value = 1;
            } else if ((x >= 74 && y >= 182 && x <= 125 && y <= 190 && mousebuttons > 0) || key == 'S') {
                R_value = 2;
            } else if ((x >= 134 && y >= 182 && x <= 185 && y <= 190 && mousebuttons > 0) || key == 'P') {
                R_value = 3;
            } else if ((x >= 194 && y >= 182 && x <= 245 && y <= 190 && mousebuttons > 0) || key == 'M') {
                R_value = 4;
            } else if ((x >= 254 && y >= 182 && x <= 305 && y <= 190 && mousebuttons > 0) || key == K_ENTER || key == 'E') {
                R_value = 5;
            }
...
void EndGame(char win, char pad)
{
    ...
    // I think this expresses which launch has the crew
    int i;
    ...
    int historyIndex = (Option == -1 && MAIL == -1) ? Data->P[win].PastMissionCount - 1
                                                    : Data->Prestige[Prestige_MannedLunarLanding].Index;

    PastInfo& historyEntry = Data->P[win].History[historyIndex];
    ...
    while (true) {
        ...
        if (((key == 'P' || key == 'M' || key == 'H' || key == 'S') || mousebuttons > 0) || R_V == 0)
        {
            ...
            if ((x >= 14 && y >= 182 && x <= 65 && y <= 190 && mousebuttons > 0) || key == 'H') {
                ...
                R_V = 4;
            } else if ((x >= 254 && y >= 182 && x <= 305 && y <= 190 && mousebuttons > 0) || key == K_ENTER) {
                R_V = 5;
            }
            ...
            helpText = "i144";
            keyHelpText = "k044";
        } else if (((x >= 14 && y >= 182 && x <= 65 && y <= 190 && mousebuttons > 0) || key == 'H') || R_V == 1) {
            // History box
            InBox(14, 182, 65, 190);
            WaitForMouseUp();
            ...
            keyHelpText = "k044";
            R_V = Burst(win);
        } else if (((x >= 74 && y >= 182 && x <= 125 && y <= 190 && mousebuttons > 0) || key == 'S') || R_V == 2) {
            // Stats box
            music_stop();
            ...
            keyHelpText = "k044";
            R_V = Burst(win);
        } else if (((x >= 134 && y >= 182 && x <= 185 && y <= 190 && mousebuttons > 0) || key == 'P') || R_V == 3) {
            // Parade
            music_stop();
            ...
            helpText = "i144";
            keyHelpText = "k044";
        } else if (((x >= 194 && y >= 182 && x <= 245 && y <= 190 && mousebuttons > 0) || key == 'M') || R_V == 4) {
            // Moon EVA
            music_stop();
            ...
            helpText = "i144";
            keyHelpText = "k044";
        } else if (((x >= 254 && y >= 182 && x <= 305 && y <= 190 && mousebuttons > 0) || key == K_ENTER) || R_V == 5) {
            music_stop();
...
// This function is called when both players in multiplayer game refuse to do anything
// the game gives up, proclaims one (or both? idk) the winner, and comes up with moon landing on its own
void FakeWin(char win)
{
    ...
    do {
        man3 = brandom(r);
    } while (man1 == man3 || man2 == man3);
    int man4;
    do {
        man4 = brandom(r);
    } while (man1 == man4 || man2 == man4 || man3 == man4);
...
void SpecialEnd()
{
    ...
    PrintOne(HistFile(10), 0);
    PrintOne(HistFile(11), 1);
    FadeIn(2, 10, 0, 0);
...
// Modem Opponent => assure prestige first that mission
    int Check = Data->Prestige[first].Index;
    ...
    int w = 0;
    for (int i = first; i < 28; i++) {
        display::graphics.setForegroundColor(9);

        if (Data->Prestige[i].Place != plr) continue;
        if (Data->PD[plr][i] & 2) continue;
    ...
    if (Option == -1 && MAIL == -1) {
        ...
        Replay(plr, Data->Prestige[first].Index, 85, 38, 150, 80, "OOOO");
    }
